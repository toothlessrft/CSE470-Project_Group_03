...
async function run() {
  ...
  const [mahasthangarh, somapura, mainamati, shabnam] = await Site.create([
    { name: "Mahasthangarh", era: "Pala Period", s_thana: "Badalgachhi", s_district: "Naogaon", s_street: "Main Road", description: "Ancient city ruins of the Pala dynasty.", architecture: "Brick walls and fortifications.", pictures: "mahasthangarh.jpg", latitude: 24.9646, longitude: 89.3379 },
    { name: "Somapura Mahavihara", era: "Pala Period", s_thana: "Paharpur Thana", s_district: "Naogaon", s_street: "Vihara Road", description: "Famous Buddhist monastery and UNESCO World Heritage Site.", architecture: "Brick monastery with central stupa.", pictures: "somapura.jpg", latitude: 25.0311, longitude: 88.9767 },
    { name: "Mainamati", era: "8th-12th Century", s_thana: "Comilla Sadar", s_district: "Comilla", s_street: "Temple Street", description: "Archaeological site with Buddhist and Hindu ruins.", architecture: "Temples and stupas scattered across the site.", pictures: "mainamati.jpg", latitude: 23.4472, longitude: 91.135 },
  ...
  const [alice, bob, charlie, dina, adcd, fatima, tariq, nusrat, rahim, sultana, jamal] = await User.create([
    ...
    { nid: "adcd", role: "museum_manager", status: "approved", name: "adcd", email: "adcd@kisuekta.com", phone: "34567", password: hash },
  ...
  const itemDefs = [
    { site: mahasthangarh, name: "Clay Pot", description: "Ancient clay storage pot", discovery_date: "2022-05-10", Type: "Pottery", specialization: { utility_pottery: "Storage", material_type: "Terracotta" }, civilization: "Pundravardhana Civilization", era: "Pala Period", region: "Naogaon", material: "Terracotta", usage: "Storage" },
    { site: mahasthangarh, name: "Cooking Vessel", description: "Pottery vessel used for cooking", discovery_date: "2021-11-15", Type: "Pottery", specialization: { utility_pottery: "Cooking", material_type: "Terracotta" }, civilization: "Pundravardhana Civilization", era: "Pala Period", region: "Naogaon", material: "Terracotta", usage: "Cooking" },
    { site: somapura, name: "Decorated Jar", description: "Jar with geometric patterns", discovery_date: "2020-03-20", Type: "Pottery", specialization: { utility_pottery: "Storage", material_type: "Ceramic" }, civilization: "Pala Civilization", era: "Pala Period", region: "Naogaon", material: "Ceramic", usage: "Storage" },
    { site: mainamati, name: "Small Cup", description: "Cup used for rituals", discovery_date: "2019-07-18", Type: "Pottery", specialization: { utility_pottery: "Ritual", material_type: "Terracotta" }, civilization: "Samatata Civilization", era: "8th-12th Century", region: "Comilla", material: "Terracotta", usage: "Ritual" },
    { site: mahasthangarh, name: "Bronze Sword", description: "Bronze weapon used in warfare", discovery_date: "2018-09-25", Type: "Metal_Object", specialization: { utility_metal: "Weapon", alloy: "Bronze Alloy" }, civilization: "Pundravardhana Civilization", era: "Pala Period", region: "Naogaon", material: "Bronze", usage: "Weapon" },
    { site: somapura, name: "Iron Spearhead", description: "Iron spearhead used in hunting", discovery_date: "2017-04-12", Type: "Metal_Object", specialization: { utility_metal: "Weapon", alloy: "Iron" }, civilization: "Pala Civilization", era: "Pala Period", region: "Naogaon", material: "Iron", usage: "Weapon" },
    { site: somapura, name: "Copper Bracelet", description: "Jewelry made of copper", discovery_date: "2020-08-22", Type: "Metal_Object", specialization: { utility_metal: "Adornment", alloy: "Copper" }, civilization: "Pala Civilization", era: "Pala Period", region: "Naogaon", material: "Copper", usage: "Adornment" },
    { site: mainamati, name: "Silver Coin", description: "Ancient currency coin", discovery_date: "2016-01-05", Type: "Metal_Object", specialization: { utility_metal: "Currency", alloy: "Silver" }, civilization: "Samatata Civilization", era: "8th-12th Century", region: "Comilla", material: "Silver", usage: "Currency" },
    { site: mahasthangarh, name: "Village Scene", description: "Painting depicting rural life", discovery_date: "2021-06-14", Type: "Paintings", specialization: { painter: "Unknown Artist", canvas_material: "Cloth Canvas", paint_type: "Natural Pigments" }, civilization: "Pundravardhana Civilization", era: "Pala Period", region: "Naogaon", material: "Cloth Canvas", usage: "Decorative" },
    { site: somapura, name: "Battlefield", description: "Historical war painting", discovery_date: "2019-09-09", Type: "Paintings", specialization: { painter: "Warrior Monk", canvas_material: "Cotton Canvas", paint_type: "Oil Paint" }, civilization: "Pala Civilization", era: "Pala Period", region: "Naogaon", material: "Cotton Canvas", usage: "Historical Record" },
    { site: mainamati, name: "Royal Portrait", description: "Portrait of a king", discovery_date: "2018-12-02", Type: "Paintings", specialization: { painter: "Royal Artisan", canvas_material: "Silk Canvas", paint_type: "Watercolor" }, civilization: "Samatata Civilization", era: "8th-12th Century", region: "Comilla", material: "Silk Canvas", usage: "Royal Commission" },
    { site: mahasthangarh, name: "Skeleton A", description: "Human skeletal remains", discovery_date: "2015-04-01", Type: "Human_Remains", specialization: { cause_of_death: "Natural Causes", gender: "Male", ethnicity: "Dravidian", age: 35, decay_percentage: 70.5, ornaments: "Beads" }, civilization: "Pundravardhana Civilization", era: "Pala Period", region: "Naogaon", material: "Skeletal Remains", usage: "Archaeological Study" },
    { site: somapura, name: "Skull Fragment", description: "Part of human skull", discovery_date: "2017-11-11", Type: "Human_Remains", specialization: { cause_of_death: "Head Injury", gender: "Female", ethnicity: "Aryan", age: 25, decay_percentage: 50, ornaments: "None" }, civilization: "Pala Civilization", era: "Pala Period", region: "Naogaon", material: "Skeletal Remains", usage: "Archaeological Study" },
    { site: mainamati, name: "Burial Remains", description: "Remains found in burial site", discovery_date: "2016-07-21", Type: "Human_Remains", specialization: { cause_of_death: "Ritual Burial", gender: "Male", ethnicity: "Mixed", age: 40, decay_percentage: 90, ornaments: "Bronze Ring" }, civilization: "Samatata Civilization", era: "8th-12th Century", region: "Comilla", material: "Skeletal Remains", usage: "Burial Practice" },
    { site: somapura, name: "Mummified Body", description: "Partially preserved remains", discovery_date: "2014-02-17", Type: "Human_Remains", specialization: { cause_of_death: "Disease", gender: "Female", ethnicity: "Indus Valley", age: 30, decay_percentage: 30.5, ornaments: "Gold Necklace" }, civilization: "Pala Civilization", era: "Pala Period", region: "Naogaon", material: "Preserved Organic Remains", usage: "Archaeological Study" },
    { site: mahasthangarh, name: "Crown", description: "Crown of hason raja", discovery_date: "2025-09-02", Type: "Metal_Object", specialization: { utility_metal: "Adornment", alloy: "Gold" }, civilization: "Bengal Zamindari Era", era: "19th Century", region: "Naogaon", material: "Gold", usage: "Royal Regalia" },
  ];
